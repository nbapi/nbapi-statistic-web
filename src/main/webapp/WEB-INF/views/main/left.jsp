	...
	<section id="col-left" class="col-left-nano">
		<div id="col-left-inner" class="col-left-nano-content">
			<div id="user-left-box"
				class="clearfix hidden-sm hidden-xs dropdown profile2-dropdown" style="  background-color: rgb(11, 255, 183);">
		...
		<div class="collapse navbar-collapse navbar-ex1-collapse"
			id="sidebar-nav" style="  background-color: rgb(11, 255, 183);">
			<ul class="nav nav-pills nav-stacked">

				<li
					<c:if test="${activeItem[0] eq 'index' }"> class ="active" </c:if>><a style="  background-color: rgb(11, 255, 183);"
				...
				<c:forEach var="item" items="${sysModuleList}">
					...
					<li
						<c:if test="${activeItem[0] eq item.businessType}"> class ="active open" </c:if>><a style="  background-color: rgb(11, 255, 183);"
						...
						<ul class="submenu">
							<c:forEach var="dimension" items="${item.oneDimensionList}">
								<li><c:if test='${"noDisplay" != dimension.displayType}'>
										<a style="  background-color: rgb(11, 255, 183);"
				...
				<li><a style="  background-background-color: rgb(11, 255, 183);" href="" class="dropdown-toggle"><i
						class="fa fa-dashboard"></i> <span>报表统计</span><i
						class="fa fa-angle-right drop-icon"></i></a>
					<ul class="submenu">
						<li><a style="  background-background-color: rgb(11, 255, 183);"
