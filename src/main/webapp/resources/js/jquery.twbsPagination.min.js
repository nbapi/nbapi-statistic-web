...
(function(e, d, a, f) {
	...
	var c = function(j, h) {
		...
		var i = (typeof this.$element.prop === "function") ? this.$element
				.prop("tagName") : this.$element.attr("tagName");
		if (i === "UL") {
	...
	c.prototype = {
		...
		buildListItems : function(g) {
			...
			if (this.options.prev) {
				var l = g.currentPage > 1 ? g.currentPage - 1
			...
			if (this.options.next) {
				var k = g.currentPage < this.options.totalPages ? g.currentPage + 1
		...
		render : function(g) {
			...
			}).toggleClass(this.options.disabledClass,
					g.currentPage === this.options.totalPages);
			h.filter(function() {
				return e(this).data("page-type") === "prev"
			}).toggleClass(this.options.disabledClass,
					!this.options.loop && g.currentPage === 1);
			h.filter(function() {
		...
		setupEvents : function() {
			...
			this.$listContainer.find("li").each(
					function() {
						var h = e(this);
						h.off();
						if (h.hasClass(g.options.disabledClass)
								|| h.hasClass(g.options.activeClass)) {
							h.click(function(i) {
								i.preventDefault()
							});
							return
		...
		makeHref : function(g) {
			return this.options.href ? this.options.href.replace(
					this.options.hrefVariable, g) : "#"
		}
	};
