...
function refreshPage(){
	...
	$.ajax({
		url : 'prod/createorder/getSummaryData',
		type : 'get',
		data : "ds=" + ds,
		dataType : 'json',
...
function initTable(title, data, ds){
	...
	$.each(data, function(index, line) {
		...
		$.each(line, function(index, value) {
			...
			else if (index == 8) tbodycompare = tbodycompare + "<td class='text-center'><a href='" + base + "/prod/createorder/createOrderDetailPage?ds=" + ds + "&username=" + username + "'>" + value + "</a></td>";
