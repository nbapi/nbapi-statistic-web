...
public class Http {
	...
	public static String Send(String method, String url, String data, String contentType){
		return Send(method, url, data, contentType, 30, 60);
	}

	public static String Send(String method, String url, String data, String contentType, int connectTimeOutSeconds, int readTimeOutSeconds){
